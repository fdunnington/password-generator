...
function getPasswordOptions() {
  ...
  let incSpecialCharacters = confirm (
    "Click OK to include special characters (e.g. * & $ ) in your password, or 'Cancel' to omit them.");

  let incUppercaseLetters = confirm (
    "And some uppercase letters?");

  let incLowercaseLetters = confirm (
    "What about some lowercase letters?");

  let incNumbers = confirm (
    "Finally, do you want to include numbers?");
